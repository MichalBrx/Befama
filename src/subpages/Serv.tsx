            ...
            <div className="flex flex-wrap max-w-lg justify-center my-8">
                ...
                <div className="">
                    ...
                    <div className='p-2 flex flex-wrap justify-center shadow-lg border-t rounded-lg mt-5 text-center'>
                        ...
                        <h2 className="font-semibold text-xl p-1 mt-3 items-center max-w-xs mx-3">Wałki i inne elementy toczone</h2>
                    </div>
                    ...
                    <div className='p-2 flex flex-wrap justify-center shadow-lg border-t rounded-lg mt-5 text-center'>
                        <img className="rounded-lg w-32 rotate-90"  src="./oprawy.jpg"  alt="Roller" />
