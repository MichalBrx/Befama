...
const Machine = () => {
  ...
  const machines = [
    ...
    {type: t("crosslappers"), tag: [
      {name: "", src: "", description: " "}
    ]},
    {type: t("webdrafters"), tag: [
    ...
    {type: t("filters"), tag: [
      {name:"Kondensery obrotowe, cyklony, filtry", src: "", description: " "}
  ]},
    {type: t("pneumatic"), tag: [
      {name:"Instalacje transportu pneumatycznego", src: "", description: " "}
  ]}
  ]
