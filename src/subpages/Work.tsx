      ...
      <div className="flex flex-wrap justify-center mb-10">
        ...
        <div className="flex justify-center p-5 flex-wrap max-w-sm ">
          <div className="py-2 flex flex-wrap justify-center">
            ...
            <p className=" w-full pt-5 pl-8 text-lg underline-offset-2 decoration-auto underline">Od kandydata oczekujemy:</p>
            <ul className="list-disc pl-12 ">
        ...
        <div className="flex justify-center p-5 flex-wrap max-w-sm ">
          <div className="py-2 flex flex-wrap justify-center">
            ...
            <ul className="list-disc pl-12 ">
              ...
              <li>uruchamianie, serwis, diagnostyka, automatyki, silników i falowników, sterowników PLC</li>
            </ul>
            <p className=" w-full pt-5 pl-8 text-lg underline-offset-2 decoration-auto underline">Od kandydata oczekujemy:</p>
            <ul className="list-disc pl-12 ">
              <li>wykształcenia zawodowego lub średniego technicznego o specjalności elektryka lub pokrewne</li>
              <li>uprawnień SEP min. do 1 kV mile widziane</li>
              <li>zdolności do pracy na wysokości</li>
              <li>doświadczenie w pracy na podobnym stanowisku będzie dodatkowym atutem</li>
        ...
        <div className="flex justify-center p-5 flex-wrap  max-w-sm">
          <div className="py-2 flex flex-wrap justify-center">
            ...
            <p className=" w-full pt-5 pl-8 text-lg underline-offset-2 decoration-auto underline">Od kandydata oczekujemy:</p>
            <ul className="list-disc pl-12 ">
              <li>wykształcenia zawodowego lub średniego technicznego o specjalności mechanik lub pokrewne</li>
              <li>umiejętność posługiwania się rysunkiem technicznym</li>
              <li>odpowiedzialności, sumienności, rzetelności</li>
              <li>zdolności do pracy na wysokośc</li>
              <li>gotowość do wyjazdów zagranicznych</li>
              <li>mile widziane uprawnienia do prowadzenia wózków widłowych oraz zwyżek</li>
              <li>doświadczenie w pracy na podobnym stanowisku będzie dodatkowym atutem</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex justify-center p-5 flex-wrap  max-w-sm">
          <div className="py-2 flex flex-wrap justify-center">
            ...
            <ul className="list-disc pl-12 my-5">
              ...
              <li>Specjalistyczne szkolenia wewnętrzne i zewnętrzne, w zależności od stanowiska i potrzeb, np. z systemów sterowania, sterowników PLC Siemensa - Lence, kurs mechaniki i konstrukcji maszyn , kurs operatora wózków widłowych</li>
            </ul>
          </div>
        </div>
