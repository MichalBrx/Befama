    ...
    <div>
        ...
        <div className="flex sm:gap-5 gap-1 mx-2 md:mx-5 lg:mx-20">
          ...
          <div className="w-14 h-full sm:w-16 lg:w-20">
            ...
            <div className="flex items-center font-medium text-black sm:text-lg md:text-xl md:ml-10 lg:ml-20 lg:gap-5">
              ...
              <div className="cursor-pointer group transition-all duration-300 p-2 sm:p-3"><a href="#work" onClick={(e) => handleClick(e)}> {t('contact')} </a><span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-px bg-black"></span></div> 
        ...
        <div className="flex justify-end h-full w-full mx-5 items-center md:mx-5 lg:mx-20">
            ...
            <div className="dropdown dropdown-hover cursor-pointer flex self-center sm:ml-5" id="Lang"> 
                <label className="flex justify-self-end w-8 h-full md:w-11 hover:scale-125 duration-200"><img src={`./${lang}.png`} alt="current flag" className="w-8 border md:w-11"/></label> 
