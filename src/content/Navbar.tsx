        ...
        <div className="flex sm:gap-5 gap-1 mx-2 md:mx-5 lg:mx-20">
          ...
          <div className="w-14 h-full sm:w-16 lg:w-20">
            ...
            <div className="flex items-center font-medium text-black sm:text-lg md:text-xl md:ml-10 lg:ml-20 lg:gap-5">
              ...
              <div className="cursor-pointer group transition-all duration-300 p-2 sm:p-3 hidden lg:block w-28"><a href="#aboutUs" onClick={(e) => handleClick(e)} >O nas</a><span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-px bg-black"></span></div> 
        ...
        <div className="flex justify-end h-full w-full mx-5 items-center md:mx-5 lg:mx-20">
            ...
            <div className="dropdown dropdown-hover mr-2 sm:mx-2" id="dropdown Menu"> 
              ...
              <ul className="dropdown-content p-2 rounded -left-10 sm:-left-0 mt-1 w-28 bg-white text-center shadow-xl border-t">
                ...
                <li className="hover:bg-gray-200 duration-200 p-3 rounded"><a href="#work" onClick={(e) => handleClick(e)} >Kariera</a></li>
            ...
            <div className="dropdown dropdown-hover cursor-pointer flex self-center sm:ml-10 lg:ml-20" id="Lang"> 
                ...
                <ul className="dropdown-content menu p-1 shadow-inner drop-shadow-md bg-base-100 rounded w-16 text-xl -left-5 m-1 mt-5 md:mt-6 lg:w-20 lg:mt-8">
